...
fun getSounds(): List<Sound> {
    val sounds = mutableListOf<Sound>()
    /**rain*/
    sounds.add(Sound(0,"Heavy rain", R.raw.heavy_rain,
        R.drawable.icon_heavy_rain,50,false,SoundCategory.Rain))
    sounds.add(Sound(1,"Light rain", R.raw.light_rain,
        R.drawable.icon_light_rain,50,false,SoundCategory.Rain))
    //TODO change icon
    sounds.add(Sound(2,"Rain in city", R.raw.rain_in_city,
        R.drawable.icon_light_rain,50,false,SoundCategory.Rain))
    //TODO change icon
    sounds.add(Sound(3,"Rain on car roof", R.raw.rain_on_car_roof,
        R.drawable.icon_light_rain,50,false,SoundCategory.Rain))
    //TODO change icon
    sounds.add(Sound(4,"Rain on city", R.raw.rain_on_city,
        R.drawable.icon_light_rain,50,false,SoundCategory.Rain))
    sounds.add(Sound(5,"Rain on roof", R.raw.rain_on_roof,
        R.drawable.icon_rain_on_roof,50,false,SoundCategory.Rain))
    sounds.add(Sound(6,"Rain on tent", R.raw.rain_on_tent,
        R.drawable.icon_rain__on_tent,50,false,SoundCategory.Rain))
    sounds.add(Sound(7,"Rain on window", R.raw.rain_on_window,
        R.drawable.icon_rain_on_window,50,false,SoundCategory.Rain))
    ...
    sounds.add(Sound(12,"Underwater", R.raw.underwater,
        R.drawable.icon_underwater,50,false,SoundCategory.Nature))
    sounds.add(Sound(13,"Wind", R.raw.wind, R.drawable.icon_wind,50,false,SoundCategory.Nature))
    sounds.add(Sound(14,"Wind leaves", R.raw.wind_leaves,
        R.drawable.icon_wind_leaves,50,false,SoundCategory.Nature))
    /**animal*/
    sounds.add(Sound(15,"Bird", R.raw.bird, R.drawable.icon_bird,50,false,SoundCategory.Animal))
    sounds.add(Sound(16,"Cat purring", R.raw.cat_purring,
        R.drawable.icon_cat_purring,50,false,SoundCategory.Animal))
    ...
    /**white noise*/
    sounds.add(Sound(34,"Brown noise", R.raw.brownnoise,
        R.drawable.icon_brown_noise,50,false,SoundCategory.WhiteNoise))
    sounds.add(Sound(35,"Pink noise", R.raw.pinknoise,
        R.drawable.icon_pink_noise,50,false,SoundCategory.WhiteNoise))
    sounds.add(Sound(36,"White noise", R.raw.white_noise,
        R.drawable.icon_white_noise,50,false,SoundCategory.WhiteNoise))
    /**white noise*/
    sounds.add(Sound(38,"Concentration", R.raw.concentration,
        R.drawable.icon_concentration,50,false,SoundCategory.Meditation))
    sounds.add(Sound(39,"Dream", R.raw.dream, R.drawable.icon_dream,50,false,SoundCategory.Meditation))
    sounds.add(Sound(37,"Meditation", R.raw.meditation,
        R.drawable.icon_meditation,50,false,SoundCategory.Meditation))
