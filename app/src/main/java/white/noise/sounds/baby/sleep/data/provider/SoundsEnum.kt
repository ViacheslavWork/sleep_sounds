...
enum class SoundsEnum(
    ...
    Snow(8, "Snow", R.raw.snow_audio_trimmer, R.drawable.icon_snow, 50, false, SoundCategory.Rain),
    ...
    Wind(13, "Wind", R.raw.wind_cutted, R.drawable.icon_wind, 50, false, SoundCategory.Nature),
    ...
    CatPurring(16, "Cat purring", R.raw.cat_pur_cutted, R.drawable.icon_cat_purring, 50, false, SoundCategory.Animal, false),
    ...
    Crowd(27, "Crowd", R.raw.crowd_cutted, R.drawable.icon_crowd, 50, false, SoundCategory.CityAndInstrument, false),
    ...
    Universe(40, "Universe", R.raw.universe_cutted, R.drawable.icon_universe, 50, false, SoundCategory.Meditation),
    ...
    Cave(43, "Cave", R.raw.cave_cutted, R.drawable.cave_svgrepo_com, 50, false, SoundCategory.Nature),
