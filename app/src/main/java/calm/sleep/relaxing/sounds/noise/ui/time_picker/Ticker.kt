...
class Ticker @JvmOverloads constructor(
    ...
    private fun initViews() {
        ...
        binding.tvAm.setOnClickListener {
            isAmSelected = true
            binding.tvAm.setTextColor(ResourcesCompat.getColor(resources, R.color.white, null))
            binding.tvPm.setTextColor(ResourcesCompat.getColor(resources, R.color.gray, null))
        }
        binding.tvPm.setOnClickListener {
            isAmSelected = false
            binding.tvPm.setTextColor(ResourcesCompat.getColor(resources, R.color.white, null))
            binding.tvAm.setTextColor(ResourcesCompat.getColor(resources, R.color.gray, null))
        }
        if (isAmSelected) {
